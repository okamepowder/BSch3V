...
public:
	...
	string	m_mfr;		//製造者記入欄 2009/02/01
	string	m_mfrpn;	//製造者型式記入欄 2009/02/01
	string	m_pkg;		//パッケージ記入欄 2009/02/01
...
public:
	...
	const char* Mfr() const;			//製造者を得る		20090203
	const char* MfrPn() const;			//製造者型式を得る		20090203
	const char* Pkg() const;			//パッケージを得る		20090203
