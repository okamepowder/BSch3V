...
bool SXBSchDoc::canEditPoints()
{
	...
	if(n==1){
		XBSchObjListIterator pObjIte =m_listTemp.begin();
		return ((*pObjIte)->id() == SXBSchObj::ID_DASH);
	}
	return false;
}
...
//const SXBSchObj* SXBSchDoc::findStart(const char* sz,bool bMatchWhole,bool bCaseSeinsitive,unsigned int targetFlags,bool selectWhenFound)
//{
//	resetSelect(RESET_SELECT_NORMAL);
//	m_strFind = sz;
