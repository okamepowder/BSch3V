...
public:
	...
	bool createdLatestVersion(){return (m_version>SXBSchSheetInfo::m_nConstDataVersion);}
...
//----- find -----
protected:
//	virtual bool findStringCompare(const char* szTarget,const char* sz,bool bMatchWhole,bool bCaseSensitive);
public:
//	const SXBSchObj*  findStart(const char* sz,bool bMatchWhole,bool bCaseSeinsitive,unsigned int targetFlags,bool selectWhenFound);
